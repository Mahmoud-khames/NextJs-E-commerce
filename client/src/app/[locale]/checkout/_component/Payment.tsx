...
import { deliveryFee, getTotalWithDelivery } from "@/lib/cart";
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 flex gap-2">
        ...
        {appliedCoupon === null && (
          <Button
            ...
            size="sm"
            onClick={() => dispatch(applyCoupon({ coupon, total: subTotal }))}
          >
      ...
      <div className="flex flex-col gap-2">
        {/* <Button
          variant="default"
          className="w-[250px] md:w-[150px] h-[56px] cursor-pointer bg-secondary hover:bg-destructive hover:text-white transition-all duration-300"
        >
          {trans.checkout.placeOrder}
        </Button> */}
      </div>
    </div>
  );
